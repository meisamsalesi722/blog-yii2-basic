                    ...
                    <div class="col-md-8">
                        ...
                        <div class="d-flex flex-wrap gap-3 mt-3">
                            <span class="badge bg-light text-dark py-2 px-3">
                                <i class="fas fa-tag text-primary"></i> <?= Html::encode($model->category->title ?? 'بدون دسته') ?>
                            </span>
        ...
        <div class="card border-0 shadow-lg" id="comments-section">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold">
                        ...
                        <span class="badge bg-primary ms-2" id="comment-count">
                            <?= Comment::find()->where(['article_id' => $model->id, 'status' => Comment::STATUS_APPROVED])->count() ?>
                        </span>
                    </h5>
            ...
            <div class="card-body p-4">
                ...
                <div class="comments-list mb-4">
                    ...
                    $approvedComments = array_filter($model->comments, function($c) {
                        return $c->status == Comment::STATUS_APPROVED;
                    });
                    ?>
                    ...
                    <div id="comment-form" class="mt-4 pt-4 border-top">
                        ...
                        <?php
                         $form = ActiveForm::begin([
                            'action' => ['/comment/create', 'article_id' => $model->id],
                            'options' => [
                                // 'data-pjax' => true, 
                                'class' => 'comment-form',
                                'id' => 'comment-form-id',
...
function resetCommentForm() {
    ...
    const form = $('.comment-form');
    form.attr('action', '/comment/create?article_id=<?= $model->id ?>');
}
